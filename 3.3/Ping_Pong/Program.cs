// Ping_Pong Application: Exercise 3.3
// PostgreSQL-backed counter. Exposed via GKE Gateway API at /pingpong.
// GET / returns 200 so GKE load balancer health checks succeed
...
// GET / — required by GKE Gateway / LB health checks (default probe path is /)
app.MapGet("/", () =>
{
...
// GET /pingpong — increments counter in PostgreSQL and returns response (HTTPRoute path)
